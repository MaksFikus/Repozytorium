...
if (isset($_GET['error']))  {
    ...
    switch ($error) {
        ...
        case 3:
                ...
                break;
        case 4:
                $errormessage = 'Podane niepoprawny adres e-mail';
                break;
    }
    */
    $errormessage = match ($error) {
        ...
        '4' => 'Podane niepoprawny adres e-mail',
        default => null
    };
}
...
<div class="container-fluid p-0">
    ...
    <div class="container py-5">
        ...
        ?>
        <form id="contact-form" method="post" action='./include/formHandler.php'> <!--Method="get" sprawi, że adres email i treść wiadomosci beda widoczne w linku-->
            <?php
            if ($errormessage):
            ?>
            <div class="mb-3">
                <div class="alert alert-danger">
                    <?= $errormessage ?> <!--Zapis alternatywny dla echo $errormessage-->
                 </div>
            </div>
            <?php
            endif;
